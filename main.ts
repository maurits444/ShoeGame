function createEnemy () {
    ...
    tiles.placeOnRandomTile(enemySprite, sprites.dungeon.floorLight1)
    enemySprite.follow(mySprite)
}
function titleScreen () {
    music.play(music.stringPlayable("A F E F D G E F ", 240), music.PlaybackMode.InBackground)
    game.splash("Outrun the Swoosh")
    effects.bubbles.startScreenEffect()
    game.showLongText("Ready? Get ready to move! Do not get tagged ", DialogLayout.Bottom)
